...
namespace EDS_Backend_final.Migrations
{
    ...
    [Migration("20231015134748_RemoveColumnIDfromCategory")]
    partial class RemoveColumnIDfromCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EDS_Backend_final.Models.DataRecipientType", b =>
                {
                    ...
                    b.Property<int>("DataRecipientRecipientID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataRecipientRecipientID");
            ...
            modelBuilder.Entity("EDS_Backend_final.Models.DataRecipientType", b =>
                {
                    b.HasOne("EDS_Backend_final.Models.DataRecipient", "DataRecipient")
                        .WithMany("RecipientTypeID")
                        .HasForeignKey("DataRecipientRecipientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
